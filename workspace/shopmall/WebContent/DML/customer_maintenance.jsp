...
<body>
 ...
 <a href="./customer_delete_form.jsp">회원정보 삭제</a><br>
 <a href="./customer_retrieval_table_form.jsp">회원정보 테이블 검색과 갱신 및 삭제(관리자)</a><br>
 <a href="./customer_retrieval_table_paging_form.jsp">회원정보 테이블 검색과 페이지 제어</a><br>
